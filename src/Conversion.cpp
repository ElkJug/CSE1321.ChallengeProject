...
void Conversion::run(){
    while (true)
    {
        try
        {
            ...
            int selected = Dialogue::spawn_int("Enter selection:");
            switch (selected)
            {
            case 1:
                // temperature conversion
                Conversion::temperature_conversion();
                break;
            case 2:
                // weight conversion
...
void Conversion::temperature_conversion(){
    ...
    double val_in = Dialogue::spawn_double("Amount:  ");
    int unit_in = Dialogue::spawn_int("From:    ");
    int unit_out = Dialogue::spawn_int("To:      ");
...
void Conversion::weight_conversion(){
...
void Conversion::currency_conversion(){
